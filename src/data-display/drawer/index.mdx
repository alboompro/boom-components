        ...
        >
          <div style={{ display: 'flex', flexDirection: 'column', height: '90%' }}>
            <div style={{ flex: '1' }}>
              ...
              />
              <p>You can assign content to Drawer, containing a footer with buttons.</p>
              <p>As this example</p>
            </div>
            <div id="footer" style={{ display: 'flex', padding: '1em', justifyContent: 'space-between' }}>
              <Button onClick={closeDrawer} type="primary">OK</Button>
              <Button onClick={closeDrawer} type="secundary">Cancel</Button>
            </div>
          </div>
        </Drawer>
      </div>
