export const imports = {
  ...
  'src/components/data-entry/dropdown/index.mdx': () =>
    import(/* webpackPrefetch: true, webpackChunkName: "src-components-data-entry-dropdown-index" */ 'src/components/data-entry/dropdown/index.mdx'),
